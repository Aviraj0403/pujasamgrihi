    ...
    return (
      <div className="mt-8 text-center py-12 bg-gradient-to-br from-primary-50 to-primary-50 rounded-2xl border-2 border-dashed border-primary-200">
        <div className="max-w-md mx-auto px-4">
          ...
          <button className="bg-primary-500 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-primary-600 transition-all hover:shadow-lg"    onClick={handleSignInClick}>
            Sign In to Review
          </button>
        </div>
      </div>
